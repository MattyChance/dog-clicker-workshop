This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app). The purpose of this simple project is for myself to revise some points in React.js with ES6 and then to use this for our Montreal free code camp workshop.
